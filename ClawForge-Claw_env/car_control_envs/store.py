...
class SessionStore:
    ...
    def create_session(
        ...
        vehicle_data = workspace_account.get("vehicle", {})
        ...
        session = {
            ...
            "vehicle_state": {
                ...
                "seats": {
                    "fl": {"position": 50, "recline": 30, "lumbar": 30, "heating": 0, "ventilation": 0},
                    "fr": {"position": 50, "recline": 30, "lumbar": 30, "heating": 0, "ventilation": 0},
                    "rl": {"position": 50, "recline": 30, "lumbar": 0, "heating": 0, "ventilation": 0},
                    "rr": {"position": 50, "recline": 30, "lumbar": 0, "heating": 0, "ventilation": 0},
                    "rc": {"position": 50, "recline": 30, "lumbar": 0, "heating": 0, "ventilation": 0},
                },
                "windows": {
                    "fl": {"open": 0},
                    "fr": {"open": 0},
                ...
                "lights": {
                    "ambient": {"on": False, "color": "white", "brightness": 50},
                    "reading": {"fl": False, "fr": False, "rl": False, "rr": False},
                    "fog": {"front": False, "rear": False},
                },
                ...
                "status": {
                    "tire_pressure": {"fl": 2.3, "fr": 2.3, "rl": 2.3, "rr": 2.3},
                    "range": 450,
